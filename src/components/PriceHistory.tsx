...
import { TrendingDown, TrendingUp, Calendar, Download, BarChart3 } from "lucide-react";
...
const PriceHistory = () => {
  ...
  const priceChange = ((currentPrice - lastMonthPrice) / lastMonthPrice * 100).toFixed(1);
  const isDecrease = currentPrice < lastMonthPrice;
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Track price trends over time and find the best time to buy your medicines
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div className="space-y-2">
              <h3 className="text-xl font-semibold text-foreground">Paracetamol 650mg Price Trends</h3>
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2">
                  <span className="text-2xl font-bold text-foreground">₹{currentPrice}</span>
                  <Badge variant={isDecrease ? "secondary" : "destructive"} className="flex items-center space-x-1">
            ...
            <CardContent className="p-6">
              <div className="h-96 w-full flex items-center justify-center bg-gradient-subtle rounded-lg">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-2">Interactive Price Chart</h3>
                  <p className="text-muted-foreground max-w-md">
                    Track price trends across multiple platforms over time. 
                    Historical data shows Tata 1mg consistently offers the lowest prices.
                  </p>
                  <div className="mt-6 grid grid-cols-2 gap-4 max-w-sm mx-auto">
                    ...
                    <div className="text-center">
                      <div className="text-lg font-bold text-primary">₹43.2</div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <Card className="p-4">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <h4 className="font-semibold text-foreground">Lowest Price Period</h4>
              </div>
              <p className="text-2xl font-bold text-secondary">₹43.2</p>
              <p className="text-sm text-muted-foreground">July 2024 on Tata 1mg</p>
            </Card>

            <Card className="p-4">
              <div className="flex items-center space-x-2 mb-2">
                <Calendar className="h-5 w-5 text-primary" />
                <h4 className="font-semibold text-foreground">Best Month to Buy</h4>
              </div>
              <p className="text-2xl font-bold text-primary">July</p>
              <p className="text-sm text-muted-foreground">Historically lowest prices</p>
            </Card>

            <Card className="p-4">
              <div className="flex items-center space-x-2 mb-2">
                <TrendingUp className="h-5 w-5 text-accent" />
                <h4 className="font-semibold text-foreground">Average Savings</h4>
              </div>
