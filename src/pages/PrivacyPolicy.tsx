  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-background rounded-2xl shadow-lg">
      <div className="space-y-6">
        <h1 className="text-4xl md:text-6xl font-bold text-foreground leading-tight">Privacy Policy</h1>
        <p className="text-sm text-muted-foreground">Last updated: August 10, 2025</p>
        <p className="text-xl text-muted-foreground">
          This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.
        </p>
        <p className="text-xl text-muted-foreground">
          We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank" className="text-primary">Free Privacy Policy Generator</a>.
        </p>
        ...
        <p className="text-xl text-muted-foreground">For the purposes of this Privacy Policy:</p>
        <ul className="list-disc space-x-5 space-y-2 text-xl text-muted-foreground">
          <li>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to MediBachat.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to MediBachat, accessible from <a href="https://medibachat.in/" rel="external nofollow noopener" target="_blank" className="text-primary">https://medibachat.in/</a></p>
          </li>
          <li>
        ...
        <h4 className="text-xl font-semibold text-foreground">Personal Data</h4>
        <p className="text-xl text-muted-foreground">
        ...
        <h4 className="text-xl font-semibold text-foreground">Usage Data</h4>
        <p className="text-xl text-muted-foreground">
        ...
        <h4 className="text-xl font-semibold text-foreground">Tracking Technologies and Cookies</h4>
        <p className="text-xl text-muted-foreground">
        ...
        <p className="text-xl text-muted-foreground">
          Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" target="_blank" className="text-primary">Free Privacy Policy website</a> article.
        </p>
        <p className="text-xl text-muted-foreground">
          We use both Session and Persistent Cookies for the purposes set out below:
        </p>
        <ul className="list-disc space-x-5 space-y-4 text-xl text-muted-foreground">
          <li>
        ...
        <h3 className="text-xl font-semibold text-foreground">Retention of Your Personal Data</h3>
        <p className="text-xl text-muted-foreground">
        ...
        <h3 className="text-xl font-semibold text-foreground">Transfer of Your Personal Data</h3>
        <p className="text-xl text-muted-foreground">
        ...
        <h3 className="text-xl font-semibold text-foreground">Delete Your Personal Data</h3>
        <p className="text-xl text-muted-foreground">
        ...
        <h3 className="text-xl font-semibold text-foreground">Disclosure of Your Personal Data</h3>
        <h4 className="text-xl font-semibold text-foreground">Business Transactions</h4>
        <p className="text-xl text-muted-foreground">
          If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
        </p>
        <h4 className="text-xl font-semibold text-foreground">Law enforcement</h4>
        <p className="text-xl text-muted-foreground">
          Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="text-xl font-semibold text-foreground">Other legal requirements</h4>
        <p className="text-xl text-muted-foreground">
        ...
        <ul className="list-disc list-inside space-y-2 text-xl text-muted-foreground">
          <li><p>By email: <a href="mailto:medibachatforyou@gmail.com" className="text-primary">medibachatforyou@gmail.com</a></p></li>
          <li><p>By visiting this page on our website: <a href="https://medibachat.in/#contact" rel="external nofollow noopener" target="_blank" className="text-primary">https://medibachat.in/#contact</a></p></li>
        </ul>
      </div>
    </div>
  )
